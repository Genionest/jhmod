...
local function CreateSnowflake(snowflakeemitter, variation, step)
    ...
    inst.AnimState:SetBank("tp_spore")
    inst.AnimState:SetBuild("tp_spore")
...
local function OnGroundAnimOver(inst)
    ...
    --     if not inst.AnimState:IsCurrentAnimation("cough_out") then
    --         -- inst.AnimState:Show("hidepre")
    --     end
    --     inst.AnimState:PlayAnimation("land")
    -- elseif inst.AnimState:IsCurrentAnimation("land") then
    --     inst:Remove()
    -- else
    --     inst.AnimState:PlayAnimation("land")
    -- end
...
return Prefab("tp_spirit_fx", snowfn, assets),
    Prefab("tp_spirit_fx_ground", groundfn, assets)
