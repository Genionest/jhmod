...
local function fn(Sim)
    ...
    -- inst.AnimState:PlayAnimation("idle_empty")
    inst.AnimState:SetBank("tp_desk")
    inst.AnimState:SetBuild("tp_desk")
    inst.AnimState:PlayAnimation("idle")
    ...
    inst.components.tpstewer.product_tbl = WARGON.DATA.tp_data_composed.desk_items
...
return Prefab( "common/tp_desk", fn, assets, prefabs),
		MakePlacer( "common/tp_desk_placer", "tp_desk", "tp_desk", "idle" ) 
