...
local DATA = WARGON.DATA.update_panel_data

local TpUpdatePanel = Class(Screen, function(self)
	SetPause(true)
	self.data = DATA
	Screen._ctor(self, "TpUpdatePanel")
