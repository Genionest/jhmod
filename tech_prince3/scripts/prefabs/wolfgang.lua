...
local function applymightiness(inst)
	...
	local health_mod = health_max - TUNING.WOLFGANG_HEALTH_NORMAL
	inst.components.health:WgAddMaxHealthModifier("wolfgang", health_mod)
...
local fn = function(inst)
	...
	inst.components.wg_start:AddFn(function(inst)
        -- skill
        inst.components.tp_skill_tree:UnlockSkill("MrMuscle")
        inst.components.tp_skill_tree:UnlockSkill("physical_training")
    end)
end
