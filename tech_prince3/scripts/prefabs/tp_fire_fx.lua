...
--             { 0,    { sparkle_max_scale*1, sparkle_max_scale*1 } },
--             { 1,    { sparkle_max_scale * 3, sparkle_max_scale * 3 } },
--         }
--     )
...
--     local vx, vy, vz = .03 * UnitRand(), 0, .03 * UnitRand()
--     local lifetime = MAX_LIFETIME * (.7 + UnitRand() * .3)
--     local px, py, pz = sphere_emitter()

--     local angle = math.random() * 360    
--     -- local uv_offset = math.random(0, 3) * .25
--     local uv_offset = math.random(0, 3) * 1
...
--         inst.wake = nil
--         EmitterManager:Hibernate(inst)
--     end
--     inst.turn_on = function(inst)
--         inst.wake = true
--         if inst.entity:IsAwake() then
--             EmitterManager:Wake(inst)
--         end
--     end
...
--     return inst
-- end
-- return Prefab( "tp_fire_fx", fn, assets) 
