...
Util:AddString("tp_potion_fire_atk", "火刀药膏", "涂抹武器以使其额外造成火属性伤害")
Util:AddString("tp_potion_ice_atk", "冰刀药膏", "涂抹武器以使其额外造成冰属性伤害")
Util:AddString("tp_potion_electric_atk", "雷刀药膏", "涂抹武器以使其额外造成雷属性伤害")
Util:AddString("tp_potion_shadow_atk", "暗刀药膏", "涂抹武器以使其额外造成暗属性伤害")
Util:AddString("tp_potion_poison_atk", "毒刀药膏", "涂抹武器以使其额外造成毒属性伤害")
Util:AddString("tp_potion_blood_atk", "血刀药膏", "涂抹武器以使其额外造成血属性伤害")
