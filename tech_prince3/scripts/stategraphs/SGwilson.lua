...
local states= 
{
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.playercontroller:Enable(false)
            PlayerAnimation(inst, "PlayAnimation", "wakeup")
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.playercontroller:Enable(false)
            PlayerAnimation(inst, "PlayAnimation", "flying_pre")
            PlayerAnimation(inst, "PlayAnimation", "flying_loop", true)
        end,
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.playercontroller:Enable(false)
            PlayerAnimation(inst, "PlayAnimation", "flying_land")
            inst.components.health:SetInvincible(true)
        end,
    ...
    State{
        ...
        onenter = function(inst)
            inst.Physics:Stop()
            PlayerAnimation(inst, "PlayAnimation", "powerup")
            inst.components.health:SetInvincible(true)
        end,
    ...
    State{
        ...
        onenter = function(inst)
            inst.Physics:Stop()
            PlayerAnimation(inst, "PlayAnimation", "powerdown")
            inst.components.health:SetInvincible(true)
        end,
    ...
    State{
        ...
        onenter = function(inst)
            inst.Physics:Stop()
            PlayerAnimation(inst, "PlayAnimation", "shock")
            PlayerAnimation(inst, "SetBloomEffectHandle", "shaders/anim.ksh")
        ...
        onexit = function(inst)
            ...
            PlayerAnimation(inst, "ClearBloomEffectHandle")
            inst.fx:Remove()
        end,
    ...
    State{
        ...
        onenter = function(inst)
            inst.Physics:Stop()
            PlayerAnimation(inst, "PlayAnimation", "shock_pst")
        end,
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.playercontroller:Enable(false)
            PlayerAnimation(inst, "PlayAnimation", "enter")
            inst.components.health:SetInvincible(true)
        end,
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.playercontroller:Enable(false)
            PlayerAnimation(inst, "PlayAnimation", "rebirth")
            
            inst.components.hunger:Pause()
            for k,v in pairs(statue_symbols) do
                PlayerAnimation(inst,"OverrideSymbol", v, "wilsonstatue", v)
            end
        end,
        ...
        onexit = function(inst)
            ...
            for k,v in pairs(statue_symbols) do
                PlayerAnimation(inst,"ClearOverrideSymbol",v)
            end
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.playercontroller:Enable(false)
            PlayerAnimation(inst, "PlayAnimation", "rebirth2")
            
            inst.components.hunger:Pause()
            for k,v in pairs(plant_symbols) do
                PlayerAnimation(inst,"OverrideSymbol", v, "lifeplant", v)
            end
        end,
    ...
    State{
        ...
        onenter = function(inst)
            PlayerAnimation(inst, "PlayAnimation", "sleep")
            inst.components.playercontroller:Enable(false)
            inst.components.health:SetInvincible(true)
        end,
    ...
    State{
        ...
        onenter = function(inst)
            ...
            --PlayerAnimation(inst,"Hide",)
            inst:PerformBufferedAction()             
        end,
        
        onexit= function(inst)
            --inst.Controller:Enable(true)
            --PlayerAnimation(inst,"Show",)
        end,
    ...
    State{
        ...
        onenter = function(inst)
            ...
            PlayerAnimation(inst,"Hide","swap_arm_carry")
            PlayerAnimation(inst, "PlayAnimation", "death")
            PlayerAnimation(inst,"SetTime",10)
        end,
    },
    ...
    State{
        ...
        tags = {"busy"},
        onenter = function(inst)
            PlayerAnimation(inst, "PlayAnimation", "fall_off")
            local sound_name = inst.soundsname or inst.prefab
            local path = inst.talker_path_override or "dontstarve/characters/"
            if inst.prefab ~= "wes" then
                inst.SoundEmitter:PlaySound(path..sound_name.."/death_voice")
    ...
    State{
        ...
        onenter = function(inst)
			...
			SpawnPlayerSkeletonHidden(inst:GetPosition())
            PlayerAnimation(inst,"Hide","swap_arm_carry")
            PlayerAnimation(inst, "PlayAnimation", "boat_death")
        ...
        --         end
                ...
                if pushanim then
                    for k,v in pairs (anims) do
    					PlayerAnimation(inst,"PushAnimation",v, k == #anims)
    				end
                else
                    PlayerAnimation(inst, "PlayAnimation", anims[1], #anims == 1)
                    for k,v in pairs (anims) do
    					if k > 1 then
    						PlayerAnimation(inst,"PushAnimation",v, k == #anims)
    					end
    ...
    State{
        ...
        onenter = function(inst)
            ...
            if inst.components.poisonable:IsPoisoned() then
                PlayerAnimation(inst, "PlayAnimation", "idle_poison_pre")
                PlayerAnimation(inst,"PushAnimation","idle_poison_loop")
                PlayerAnimation(inst,"PushAnimation","idle_poison_pst", false)
			elseif inst.components.temperature:GetCurrent() < 10 then
				PlayerAnimation(inst, "PlayAnimation", "idle_shiver_pre")
				PlayerAnimation(inst,"PushAnimation","idle_shiver_loop")
				PlayerAnimation(inst,"PushAnimation","idle_shiver_pst", false)
            elseif inst.components.temperature:GetCurrent() > 60 then
                --plug in overheats once they're done
                PlayerAnimation(inst, "PlayAnimation", "idle_hot_pre")
                PlayerAnimation(inst,"PushAnimation","idle_hot_loop")
                PlayerAnimation(inst,"PushAnimation","idle_hot_pst", false)
			elseif inst.components.hunger:GetPercent() < TUNING.HUNGRY_THRESH then
                PlayerAnimation(inst, "PlayAnimation", "hungry")
                inst.SoundEmitter:PlaySound("dontstarve/wilson/hungry")    
            elseif inst.components.sanity:GetPercent() < .5 then
				PlayerAnimation(inst, "PlayAnimation", "idle_inaction_sanity")
            elseif inst:HasTag("groggy") then
                PlayerAnimation(inst, "PlayAnimation", "idle_groggy01_pre")
                PlayerAnimation(inst,"PushAnimation","idle_groggy01_loop")
                PlayerAnimation(inst,"PushAnimation","idle_groggy01_pst", false)                
            else
                PlayerAnimation(inst, "PlayAnimation", "idle_inaction")
            end
        end,
    ...
    State{ name = "chop_start",
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", inst.prefab == "woodie" and "woodie_chop_pre" or "chop_pre")
        end,
    ...
    State{
        ...
        onenter = function(inst)
            ...
            if inst.prefab == "wilba" and inst.were then
                ...
                if inst.atk_2 == true then                    
                    PlayerAnimation(inst, "PlayAnimation", "atk_2_werewilba")
                    inst.atk_2 = nil
                else
                    PlayerAnimation(inst, "PlayAnimation", "atk_werewilba")
                    inst.atk_2 = true
                end
                inst.SoundEmitter:PlaySound("dontstarve/wilson/attack_whoosh",nil,.8)
            else
                PlayerAnimation(inst, "PlayAnimation", inst.prefab == "woodie" and "woodie_chop_loop" or "chop_loop")
            end
        end,
        ...
        events=
        {
            EventHandler("unequip", function(inst) inst.sg:GoToState("idle") end ),
            EventHandler("animover", function(inst) 
                --PlayerAnimation(inst, "PlayAnimation", "chop_pst") 
                inst.sg:GoToState("idle")
            end ),
    ...
    State{ name = "pan_start",
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "pan_pre")
        end,
    ...
    State{
        ...
        onenter = function(inst)
            inst.sg.statemem.action = inst:GetBufferedAction()
            PlayerAnimation(inst, "PlayAnimation", "pan_loop",true) 
    ...
    State{ name = "shear_start",
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "cut_pre")
        end,
    ...
    State{
        ...
        onenter = function(inst)
            inst.sg.statemem.action = inst:GetBufferedAction()
            PlayerAnimation(inst, "PlayAnimation", "cut_loop")
        end,
     ...
     State{ name = "shear_end",
        tags = {"working"},
        onenter = function(inst)
            PlayerAnimation(inst, "PlayAnimation", "cut_pst")
        end,
    ...
    State {
        ...
        onenter = function(inst)
            ...
            inst.sg.statemem.action = inst:GetBufferedAction()
            PlayerAnimation(inst, "PlayAnimation", "lens")
        end,
    ...
    State{
        ...
        onenter = function(inst)
            ...
            PlayerAnimation(inst, "PlayAnimation", "lens_pst")
        end,
    ...
    State {
        ...
        onenter = function(inst)
            ...
            inst.sg.statemem.action = inst:GetBufferedAction()
            PlayerAnimation(inst, "PlayAnimation", "goggle")
        end,
    ...
    State{
        ...
        onenter = function(inst)
            ...
            PlayerAnimation(inst, "PlayAnimation", "goggle_pst")
        end,
        ...
        events=
        {
            ...
            EventHandler("animover", function(inst)
                if inst.prefab ~= "wilba" or not inst.were then
                    PlayerAnimation(inst, "PlayAnimation", "pickaxe_pst")
                end
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "hide")
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "hide_idle", true)
            inst:AddTag("notarget")
        end,
    ...
    State{
        ...
        onenter = function(inst)            
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "hideshell")
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "hideshell_idle", true)
        end,
    ...
    State{
        ...
        onenter = function(inst)
            inst:ClearBufferedAction()
            inst.SoundEmitter:PlaySound("dontstarve/wilson/hit")        
            PlayerAnimation(inst, "PlayAnimation", "hitshell")
            --local sound_name = inst.soundsname or inst.prefab
    ...
    State{ name = "crop_dust",
        ...
        onenter = function(inst)
            ...
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "cropdust_pre")
            PlayerAnimation(inst,"PushAnimation","cropdust_loop")
            PlayerAnimation(inst,"PushAnimation","cropdust_pst", false)
        end,
    ...
    State{
        ...
        onenter = function(inst)
            if inst.prefab == "wilba" and inst.were then
                ...
                PlayerAnimation(inst, "PlayAnimation", "shovel_loop")
            end
...
--]]                
        ...
        events=
        {
            ...
            EventHandler("animover", function(inst)
                if inst.prefab ~= "wilba" or not inst.were then
                    PlayerAnimation(inst, "PlayAnimation", "shovel_pst") 
                end
   ...
   State{ name = "bugnet_start",
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "bugnet_pre")
        end,
    ...
    State{
        ...
        onenter = function(inst)
            PlayerAnimation(inst, "PlayAnimation", "bugnet")
    ...
    State {
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst,"Hide","RIPPLES")
            PlayerAnimation(inst, "PlayAnimation", "fishing_pre") --24
            PlayerAnimation(inst,"PushAnimation","fishing_idle") --38
            PlayerAnimation(inst,"PushAnimation","fishing_idle") 
            PlayerAnimation(inst,"PushAnimation","bite_heavy_pre") --4
            PlayerAnimation(inst,"PushAnimation","bite_heavy_loop") --13
            PlayerAnimation(inst,"PushAnimation","bite_heavy_loop")
            PlayerAnimation(inst,"PushAnimation","fish_catch", false) --13
        end,
   ...
   State{ name = "fishing_pre",
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "fishing_pre")
        end,
        ...
        onenter = function(inst, pushanim)
            if pushanim then
                if type(pushanim) == "string" then
                    PlayerAnimation(inst, "PlayAnimation", pushanim)
                end
                PlayerAnimation(inst,"PushAnimation","fishing_idle", true)
            else
                PlayerAnimation(inst, "PlayAnimation", "fishing_idle", true)
            end
            local equippedTool = inst.components.inventory:GetEquippedItem(EQUIPSLOTS.HANDS)
            if equippedTool and equippedTool.components.fishingrod then
    ...
    State{ name = "fishing_pst",
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "fishing_pst")
        end,
    ...
    State{
        ...
        tags = {"fishing", "nibble"},
        onenter = function(inst)
            PlayerAnimation(inst, "PlayAnimation", "bite_light_pre")
            PlayerAnimation(inst,"PushAnimation","bite_light_loop", true)
            inst.sg:SetTimeout(1 + math.random())
            inst.SoundEmitter:PlaySound("dontstarve/common/fishingpole_fishinwater", "splash")
        end,
    ...
    State{
        ...
        tags = {"fishing"},
        onenter = function(inst)
            PlayerAnimation(inst, "PlayAnimation", "bite_heavy_pre")
            PlayerAnimation(inst,"PushAnimation","bite_heavy_loop", true)
            inst.SoundEmitter:PlaySound("dontstarve/common/fishingpole_fishinwater", "splash")
            inst.SoundEmitter:PlaySound("dontstarve/common/fishingpole_strain", "strain")
        end,
    ...
    State{
        ...
        onenter = function(inst, build)
            PlayerAnimation(inst, "PlayAnimation", "fish_catch")
            print("Using ", build, " to swap out fish01")            
            PlayerAnimation(inst,"OverrideSymbol", "fish01", build, "fish01")
            
            -- PlayerAnimation(inst,"OverrideSymbol", "fish_body", build, "fish_body")
            -- PlayerAnimation(inst,"OverrideSymbol", "fish_eye", build, "fish_eye")
            -- PlayerAnimation(inst,"OverrideSymbol", "fish_fin", build, "fish_fin")
            -- PlayerAnimation(inst,"OverrideSymbol", "fish_head", build, "fish_head")
            -- PlayerAnimation(inst,"OverrideSymbol", "fish_mouth", build, "fish_mouth")
            -- PlayerAnimation(inst,"OverrideSymbol", "fish_tail", build, "fish_tail")
        end,
        
        onexit = function(inst)
            PlayerAnimation(inst,"ClearOverrideSymbol","fish01")
            -- PlayerAnimation(inst,"ClearOverrideSymbol","fish_body")
            -- PlayerAnimation(inst,"ClearOverrideSymbol","fish_eye")
            -- PlayerAnimation(inst,"ClearOverrideSymbol","fish_fin")
            -- PlayerAnimation(inst,"ClearOverrideSymbol","fish_head")
            -- PlayerAnimation(inst,"ClearOverrideSymbol","fish_mouth")
            -- PlayerAnimation(inst,"ClearOverrideSymbol","fish_tail")
        end,
    ...
    State{
        ...
        onenter = function(inst)
            ...
            PlayerAnimation(inst, "PlayAnimation", "fish_nocatch")
        end,
   ...
   State{
        ...
        onenter = function(inst)
            ...
            PlayerAnimation(inst, "PlayAnimation", "quick_eat")
            inst.components.hunger:Pause()
        end,
   ...
   State{
        ...
        onenter = function(inst)
            ...
            for k = 1, math.random(2,3) do
				...
				if k == 1 then
					PlayerAnimation(inst, "PlayAnimation", aname, false)
				else
					PlayerAnimation(inst,"PushAnimation",aname, false)
				end
            end
        end,
    ...
    State
    {
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "give")
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "pickup")
    ...
    State{
        ...
        onenter = function(inst, timeout)
            ...
            PlayerAnimation(inst, "PlayAnimation", "build_pre")
            PlayerAnimation(inst,"PushAnimation","build_loop", true)
        end,
        ...
        ontimeout = function(inst)
            ...
            PlayerAnimation(inst, "PlayAnimation", "build_pst")
            inst:PerformBufferedAction()
        end,
    ...
    State{
        ...
        onenter = function(inst, timeout)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "form_log")
    ...
    State{
        ...
        onenter = function(inst, timeout)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "fertilize")                
        end,
    ...
    State{
        ...
        onenter = function(inst, timeout)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "short_fertilize")                
        end,
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            inst.SoundEmitter:PlaySound("dontstarve/wilson/make_trap", "make")
            PlayerAnimation(inst, "PlayAnimation", "wrap_pre")
            PlayerAnimation(inst,"PushAnimation","wrap_loop", true)
        ...
        ontimeout = function(inst)
            ...
            inst.SoundEmitter:KillSound("make")
            PlayerAnimation(inst, "PlayAnimation", "wrap_pst")
        end,
    ...
    State{
        ...
        onenter = function(inst)
            ...
            if not inst.AnimState:IsCurrentAnimation("wrap_loop") then
                PlayerAnimation(inst, "PlayAnimation", "wrap_loop", true)
            end
        end,
    ...
    State{
        ...
        onenter = function(inst, timeout)
            ...
            PlayerAnimation(inst, "PlayAnimation", "tamp_pre")    
        end,
    ...
    State{
        ...
        onenter = function(inst, timeout)
            ...
            inst.sg:SetTimeout(timeout or 1)
            inst.components.locomotor:Stop()         
            PlayerAnimation(inst,"PushAnimation","tamp_loop",true)
        end,
        ...
        ontimeout= function(inst)
            PlayerAnimation(inst, "PlayAnimation", "tamp_pst")
    ...
    State{
        ...
        onenter = function(inst)
        inst.components.locomotor:Stop()
        PlayerAnimation(inst, "PlayAnimation", "idle_onemanband1_pre")
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.components.locomotor:Stop()
            --PlayerAnimation(inst, "PlayAnimation", "idle_onemanband1_pre")
            PlayerAnimation(inst, "PlayAnimation", "idle_onemanband1_loop")
            inst.SoundEmitter:PlaySound("dontstarve/wilson/onemanband")
        end,
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "idle_onemanband1_pst")
            PlayerAnimation(inst,"PushAnimation","idle_onemanband2_pre")
            PlayerAnimation(inst,"PushAnimation","idle_onemanband2_loop")
            PlayerAnimation(inst,"PushAnimation","idle_onemanband2_pst", false)  
            inst.SoundEmitter:PlaySound("dontstarve/wilson/onemanband") 
        end,
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "flute")

            inst.sg.statemem.flute = inst:GetBufferedAction().invobject

            PlayerAnimation(inst,"OverrideSymbol", "pan_flute01", inst.sg.statemem.flute.flutebuild or "pan_flute", inst.sg.statemem.flute.flutesymbol or "pan_flute01")
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "horn")

            inst.sg.statemem.horn = inst:GetBufferedAction().invobject

            PlayerAnimation(inst,"OverrideSymbol", "horn01", inst.sg.statemem.horn.hornbuild or "horn", inst.sg.statemem.horn.hornsymbol or "horn01")
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "bell")
            PlayerAnimation(inst,"OverrideSymbol", "bell01", "bell", "bell01")
            --PlayerAnimation(inst,"Hide","ARM_carry") 
            PlayerAnimation(inst,"Show","ARM_normal")
            if inst.components.inventory.activeitem and inst.components.inventory.activeitem.components.instrument then
                inst.components.inventory:ReturnActiveItem()
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "book")
            PlayerAnimation(inst,"OverrideSymbol", "book_open", "book_uniqueitem_swap", "book_open")
            PlayerAnimation(inst,"OverrideSymbol", "book_closed", "book_uniqueitem_swap", "book_closed")
            PlayerAnimation(inst,"OverrideSymbol", "book_open_pages", "book_uniqueitem_swap", "book_open_pages")
            --PlayerAnimation(inst,"Hide","ARM_carry") 
            PlayerAnimation(inst,"Show","ARM_normal")
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.components.combat:StartAttack()
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "speargun")
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.components.combat:StartAttack()
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "throw")
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "catch_pre")
            inst:PerformBufferedAction()
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "catch")
    ...
    State{
        ...
        onenter = function(inst)
            ...
            if (weapon and weapon:HasTag("hand_gun")) or (otherequipped and otherequipped:HasTag("hand_gun")) then
                PlayerAnimation(inst, "PlayAnimation", "hand_shoot")
            else
                PlayerAnimation(inst, "PlayAnimation", "shoot")
            end
    ...
    State{
        ...
        onenter = function(inst)
            ...
            PlayerAnimation(inst, "PlayAnimation", "goggle_fast")
    ...
    State{
        ...
        onenter = function(inst)
            ...
            PlayerAnimation(inst, "PlayAnimation", "goggle_fast_pst")
        end,
        ...
        onenter = function(inst)
            ...
            if inst.components.rider:IsRiding() then
                ...
                if weapon and (weapon.components.weapon.projectile or weapon:HasTag("rangedweapon")) then
                    PlayerAnimation(inst, "PlayAnimation", "player_atk_pre")
                    PlayerAnimation(inst,"PushAnimation","player_atk", false)

                    cooldown = math.max(cooldown, 13 * FRAMES)
                else
                    PlayerAnimation(inst, "PlayAnimation", "atk_pre")
                    PlayerAnimation(inst,"PushAnimation","atk", false)
            ...
            elseif inst.prefab == "wilba" and inst.were then
                ...
                PlayerAnimation(inst, "PlayAnimation", "punch")
                inst.SoundEmitter:PlaySound("dontstarve/wilson/attack_whoosh",nil,.5)
            end
    ...
    State{
        ...
        onenter = function(inst)
            ...
            PlayerAnimation(inst, "PlayAnimation", GetRunStateAnim(inst).."_pre")
    ...
    State{
        ...
        onenter = function(inst) 
            ...
            PlayerAnimation(inst, "PlayAnimation", anim)
        end,
    ...
    State{
        ...
        onenter = function(inst) 
            ConfigureRunState(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", GetRunStateAnim(inst).."_pst")            
        end,
    ...
    State{
        ...
        onenter = function(inst) 
            ...
            PlayerAnimation(inst, "PlayAnimation", "walk_monkey_pre")
    ...
    State{
        ...
        onenter = function(inst) 
            ...
            inst.AnimState:SetBank("wilbur_run")
            inst.AnimState:SetBuild("wilbur_run")
            PlayerAnimation(inst, "PlayAnimation", "walk_monkey_loop")
            
            if inst.components.inventory:GetEquippedItem(EQUIPSLOTS.HANDS) then
                PlayerAnimation(inst,"Show","TAIL_carry")
                PlayerAnimation(inst,"Hide","TAIL_normal")
            end
        end,
        ...
        onexit = function(inst)
            ...
            inst.AnimState:SetBuild(inst.prefab)
            inst.Transform:SetFourFaced()
            PlayerAnimation(inst,"Hide","TAIL_carry")
            PlayerAnimation(inst,"Show","TAIL_normal")
        end,
    ...
    State{
        ...
        onenter = function(inst)
            ...
            PlayerAnimation(inst, "PlayAnimation", "item_hat")
        end,
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.locomotor:StopMoving()
            PlayerAnimation(inst, "PlayAnimation", "item_in")
        end,
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.locomotor:StopMoving()
            PlayerAnimation(inst, "PlayAnimation", "item_out")
        end,
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "light_fire")
            PlayerAnimation(inst,"PushAnimation","light_fire_pst", false)
        end,
	...
	State{
        ...
        onenter = function(inst)
            ...
            PlayerAnimation(inst, "PlayAnimation", "bedroll")
        ...
        onexit = function(inst)
            inst.components.health:SetInvincible(false)
            inst.components.playercontroller:Enable(true)
        	PlayerAnimation(inst,"ClearOverrideSymbol","bedroll")          
        end,
    ...
    State{
        ...
        onenter = function(inst)
            ...
            PlayerAnimation(inst, "PlayAnimation", "sneeze")
    ...
    State{
        ...
        onenter = function(inst)
            inst.SoundEmitter:PlaySound("dontstarve/wilson/hit")        
            PlayerAnimation(inst, "PlayAnimation", "hit")
            inst:ClearBufferedAction()
	...
	State{
		...
		onenter = function(inst)
			...
			PlayerAnimation(inst, "PlayAnimation", "teleport")
	...
	State{
        ...
        onenter = function(inst)
			...
			inst.components.playercontroller:Enable(false)
            PlayerAnimation(inst, "PlayAnimation", "amulet_rebirth")
            TheCamera:SetDistance(14)
            inst.HUD:Hide()
            PlayerAnimation(inst,"OverrideSymbol", "FX", "player_amulet_resurrect", "FX")
        end,
        ...
        onexit= function(inst)
			...
			inst.components.playercontroller:Enable(true)
            PlayerAnimation(inst,"ClearOverrideSymbol","FX")
    ...
    State{
        ...
        onenter = function(inst)
            inst.sg.statemem.action = inst:GetBufferedAction()
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "jump")
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.components.playercontroller:Enable(false)
            PlayerAnimation(inst, "PlayAnimation", "teleport_out")
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.DynamicShadow:Enable(false)
            inst.components.playercontroller:Enable(false)
            PlayerAnimation(inst, "PlayAnimation", "teleport_finish") 
            PlayerAnimation(inst, "SetBloomEffectHandle",  "shaders/anim.ksh" )   
            inst.components.locomotor:Stop()
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.playercontroller:Enable(false)
            PlayerAnimation(inst, "PlayAnimation", "teleport_in") 
            local equipped = inst.components.inventory:GetEquippedItem(EQUIPSLOTS.HANDS)
            if equipped and equipped:HasTag("telebrella") then            
        ...
        onexit = function(inst)
            inst.components.playercontroller:Enable(true)
            PlayerAnimation(inst, "SetBloomEffectHandle", "")   
        end,
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.playercontroller:Enable(false)
            PlayerAnimation(inst, "PlayAnimation", "staff") 
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.components.playercontroller:Enable(false)
            PlayerAnimation(inst, "PlayAnimation", "telescope", false)
            PlayerAnimation(inst,"PushAnimation","telescope_pst", false)
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.Physics:Stop()
            inst.components.playercontroller:Enable(false)
            PlayerAnimation(inst, "PlayAnimation", "reform")
            inst.components.health:SetInvincible(true)
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.Physics:Stop()
            inst.components.playercontroller:Enable(false)           
            PlayerAnimation(inst, "PlayAnimation", "transform_pre")
            inst.components.health:SetInvincible(true)
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.playercontroller:Enable(false)
            inst.Physics:Stop()            
            PlayerAnimation(inst, "PlayAnimation", "transform_pst")
            inst.components.health:SetInvincible(true)
        end,
    ...
    State{
        ...
        onenter = function(inst)
            ...
            PlayerAnimation(inst, "PlayAnimation", "frozen")
            inst.SoundEmitter:PlaySound("dontstarve/common/freezecreature")
            PlayerAnimation(inst,"OverrideSymbol", "swap_frozen", "frozen", "frozen")
        end,
        
        onexit = function(inst)
            inst.components.playercontroller:Enable(true)

            PlayerAnimation(inst,"ClearOverrideSymbol","swap_frozen")
        end,
    ...
    State{
        ...
        onenter = function(inst) 
            ...
            PlayerAnimation(inst, "PlayAnimation", "frozen_loop_pst", true)
    ...
    State{
        ...
        onenter = function(inst)
            ...
            if fan then
                PlayerAnimation(inst,"OverrideSymbol", "fan01", fan.animinfo, "fan01")
            end

            PlayerAnimation(inst, "PlayAnimation", "fan")
            PlayerAnimation(inst,"Show","ARM_normal")
    ...
    State{
        ...
        onenter = function(inst, data)
            ...
            PlayerAnimation(inst, "PlayAnimation", "cower")
        end,
    ...
    State{
        ...
        onenter = function(inst, data)
            PlayerAnimation(inst, "PlayAnimation", "grab_loop")
        end,
        events=
        {
            EventHandler("animover", function(inst)
    ...
    State{
        ...
        onenter = function(inst, data)
            ...
            PlayerAnimation(inst, "PlayAnimation", "yawn")
        end,
    ...
    State{
        ...
        tags = {"busy"},
        onenter = function(inst)
            PlayerAnimation(inst, "PlayAnimation", "dismount")
            inst.SoundEmitter:PlaySound("dontstarve/beefalo/saddle/dismount")         
        end,
   ...
   State{
        ...
        onenter = function(inst, pushanim)
            ...
            if pushanim then
                PlayerAnimation(inst,"PushAnimation","idle_loop", true)
            else
                PlayerAnimation(inst, "PlayAnimation", "idle_loop", true)
            end
    ...
    State{
        ...
        onenter = function(inst)
            PlayerAnimation(inst, "PlayAnimation", "graze_loop", true)
    ...
    State{
        ...
        onenter = function(inst)
            PlayerAnimation(inst, "PlayAnimation", "graze2_pre")
            PlayerAnimation(inst,"PushAnimation","graze2_loop")
            inst.sg:SetTimeout(1 + math.random() * 5)
        end,

        ontimeout = function(inst)
            PlayerAnimation(inst, "PlayAnimation", "graze2_pst")
    ...
    State{
        ...
        onenter = function(inst)
            PlayerAnimation(inst, "PlayAnimation", "bellow")
    ...
    State{
        ...
        onenter = function(inst)
            PlayerAnimation(inst, "PlayAnimation", "shake")
        end,
...
State{
    ...
    State{
        ...
        onenter = function(inst)
            ...
            PlayerAnimation(inst, "PlayAnimation", "mount")
    ...
    State{
        ...
        onenter = function(inst)
            ...
            PlayerAnimation(inst, "PlayAnimation", "buck")
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.playercontroller:Enable(false)
            PlayerAnimation(inst, "PlayAnimation", "bucked")
            PlayerAnimation(inst,"PushAnimation","buck_pst", false)
        end,
    ...
    State
    {
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "unsaddle_pre")
            PlayerAnimation(inst,"PushAnimation","unsaddle", false)
    ...
    State{
        ...
        onenter = function(inst)
            ...
            PlayerAnimation(inst,"OverrideSymbol", "swap_goosplat", "goo", "swap_goosplat")
            PlayerAnimation(inst, "PlayAnimation", "hit")            
        ...
        onexit = function(inst)
            ...
            PlayerAnimation(inst,"ClearOverrideSymbol","swap_goosplat")
        end,
    },
    State{
        name = "pinned",
        ...
        onenter = function(inst)
            ...
            PlayerAnimation(inst, "PlayAnimation", "distress_loop", true)
             -- TODO: struggle sound
    ...
    State{
        ...
        onenter = function(inst)
            ...
            PlayerAnimation(inst, "PlayAnimation", "hit_goo")
    ...
    State{
        ...
        onenter = function(inst)
            ...
            PlayerAnimation(inst, "PlayAnimation", "distress_pst")
   ...
   State{
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            PlayerAnimation(inst, "PlayAnimation", "research")
        end,
    ...
    State{
        ...
        onenter = function(inst)
            PlayerAnimation(inst, "PlayAnimation", "idle_loop")
            inst.components.health:SetInvincible(true)
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.health:SetInvincible(true)
            PlayerAnimation(inst, "PlayAnimation", "shipwrecked_portal_pre")
            PlayerAnimation(inst,"PushAnimation","shipwrecked_portal_loop", true)
...
-- ------------------------------------------
    ...
    State{
        ...
        onenter = function(inst)
            inst.components.health:SetInvincible(true)
            PlayerAnimation(inst, "PlayAnimation", "hamlet_portal_pre")
            PlayerAnimation(inst,"PushAnimation","hamlet_portal_loop", true)
    ...
    State{
        ...
        onenter = function(inst, duration)
            ...
            PlayerAnimation(inst, "PlayAnimation", "idle_sanity_pre", false)
            PlayerAnimation(inst,"PushAnimation","idle_sanity_loop", true)
