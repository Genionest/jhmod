...
local AkIntroScreen = Class(Screen, function(self, Data)
	SetPause(true)
	Screen._ctor(self, "AkIntroScreen")
	self.data = Data
...
function AkIntroScreen:MenuPageTurn(dt)
	self.data:PageTurn(dt)
	self:SetMenu()
end

function AkIntroScreen:MiniMenuPageTurn(dt)
	local shelf = self.data:GetItem()
	shelf:PageTurn(dt)
	self:SetMiniMenu()
end

function AkIntroScreen:BookPageTurn(dt)
	local book = self.data:GetItem():GetItem()
	book:PageTurn(dt)
	self:SetBlackboard()
end

function AkIntroScreen:SetMenu()
...
function AkIntroScreen:SetMiniMenu()
...
function AkIntroScreen:SetBlackboard()
	local book = self.data:GetItem():GetItem()
