...
local TpSkillTreeScreen = Class(Screen, function(self, data, owner)
	SetPause(true)
	self.data = data
    self.owner = owner
	Screen._ctor(self, "TpSkillTreeScreen")
	...
	self.balance_bg:AddChild(Image(
		"minimap/minimap_data.xml", "evergreen.png"
	))
...
function TpSkillTreeScreen:Init()
...
function TpSkillTreeScreen:ItemBoardPageTurn(dt)
...
function TpSkillTreeScreen:SetItemBoard()
...
function TpSkillTreeScreen:SetBalance()
...
function TpSkillTreeScreen:SetLevel()
	-- local level = self.data:GetLevel(self)
	-- self.level:SetString(level)
end

function TpSkillTreeScreen:Test()

end

return TpSkillTreeScreen