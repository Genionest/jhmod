...
{   
    ...
    State{
        ...
        onenter = function(inst)
            inst.SoundEmitter:PlaySound("dontstarve/creatures/mctusk/hurt")
        ...
        timeline=
        {
            TimeEvent(20*FRAMES, function(inst) inst.components.combat:DoAttack() inst.sg:RemoveStateTag("attack") inst.sg:RemoveStateTag("busy") end),
        },
...
return StateGraph("morph_walrus", states, events, "idle", actionhandlers)
