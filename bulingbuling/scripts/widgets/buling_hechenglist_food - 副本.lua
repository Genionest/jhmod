...
function buling_hechenglist:page1()
	...
	function ()
		...
		self.cailiao4 = self.gezi4:AddChild(ImageButton("images/inventoryimages.xml", "carrot_seeds.tex"))
		self.cailiao4 = self.gezi4:AddChild(ImageButton("images/inventoryimages.xml", "asparagus_seeds.tex"))
		self.cailiao5 = self.gezi5:AddChild(ImageButton("images/hud.xml", "turnarrow_icon.tex"))
