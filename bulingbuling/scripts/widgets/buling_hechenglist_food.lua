...
buling_hechenglist_food = Class(Widget, function(self,owner)
	...
	self.page = 1
	self.pagemax = 2
	GetPlayer():ListenForEvent("OpenBuling_food",function()
		self:Open()
	end)
	GetPlayer():ListenForEvent("CloseBuling_food",function()
		self:Close()
	end)
	--背景
...
function buling_hechenglist_food:page1()
	--烤制料理模块
	self.item1 = self.image:AddChild(ImageButton("images/inventoryimages/buling_cook_kao.xml", "buling_cook_kao.tex"))
	self.item1:SetPosition(-120, 190, 0)
	self.item1:SetOnClick(
	function ()
		self:QK()
		self.tubiao = self.image2:AddChild(Image("images/inventoryimages/buling_cook_kao.xml", "buling_cook_kao.tex"))
		self.tubiao:SetPosition(-100, 100, 0)
		self.text1 = self.image2:AddChild(Text(BODYTEXTFONT, 50,STRINGS.NAMES.BULING_COOK_KAO))
		self.text1:SetPosition(50, 100, 0)
		self.text2 = self.image2:AddChild(Text(BODYTEXTFONT, 25,STRINGS.CHARACTERS.GENERIC.DESCRIBE.BULING_COOK_KAO))
		...
		self.cailiao5 = self.gezi5:AddChild(ImageButton("images/inventoryimages.xml", "cutstone.tex"))
		self.cailiao6 = self.gezi6:AddChild(ImageButton("images/inventoryimages.xml", "cutstone.tex"))
		self.cailiao7 = self.gezi7:AddChild(ImageButton("images/inventoryimages.xml", "charcoal.tex"))
		self.cailiao8 = self.gezi8:AddChild(ImageButton("images/inventoryimages.xml", "torch.tex"))
		self.cailiao9 = self.gezi9:AddChild(ImageButton("images/inventoryimages.xml", "charcoal.tex"))
	end)
	--锅料理模块
	...
	--蒸料理模块
	self.item3 = self.image:AddChild(ImageButton("images/inventoryimages/buling_cook_zheng.xml", "buling_cook_zheng.tex"))
	self.item3:SetPosition(40, 190, 0)
	self.item3:SetOnClick(
	function ()
		self:QK()
		self.tubiao = self.image2:AddChild(Image("images/inventoryimages/buling_cook_zheng.xml", "buling_cook_zheng.tex"))
		self.tubiao:SetPosition(-100, 100, 0)
		
		self.text1 = self.image2:AddChild(Text(BODYTEXTFONT, 50,STRINGS.NAMES.BULING_COOK_ZHENG))
		self.text1:SetPosition(50, 100, 0)
		
		self.text2 = self.image2:AddChild(Text(BODYTEXTFONT, 25,STRINGS.CHARACTERS.GENERIC.DESCRIBE.BULING_COOK_ZHENG))
		self.text2:SetPosition(80, -50, 0)
	...
	--面包
	self.item4 = self.image:AddChild(ImageButton("images/inventoryimages/buling_bread.xml", "buling_bread.tex"))
...
function buling_hechenglist_food:page2()
	...
	function ()
		...
		self.text1 = self.image2:AddChild(Text(BODYTEXTFONT, 50,STRINGS.NAMES.BULING_COOK_KAO))
		self.text1:SetPosition(50, 100, 0)
		self.text2 = self.image2:AddChild(Text(BODYTEXTFONT, 30,STRINGS.CHARACTERS.GENERIC.DESCRIBE.BULING_COOK_KAO))
		self.text2:SetPosition(80, -50, 0)
	...
	function ()
		...
		self.text2 = self.image2:AddChild(Text(BODYTEXTFONT, 30,STRINGS.CHARACTERS.GENERIC.DESCRIBE.BULING_COOK_ZHENG))
		self.text2:SetPosition(80, -50, 0)
	...
	function ()
		...
		self.text2 = self.image2:AddChild(Text(BODYTEXTFONT, 30,STRINGS.CHARACTERS.GENERIC.DESCRIBE.BULING_SANGUBAO))
		self.text2:SetPosition(80, -50, 0)
